...
//   controller('neighbourhoodSearchController', function ($scope, searchAPIService, itemsAPIService, $stateParams) {
//     // $scope.resultsList = [];
//
//     $scope.devs=[];
...
//
//     itemsAPIService.getNeighbourhood($window.sessionStorage.companyAccountId)
//       .then(
